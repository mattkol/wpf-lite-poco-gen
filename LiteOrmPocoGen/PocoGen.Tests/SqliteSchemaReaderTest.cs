// -----------------------------------------------------------------------
// <copyright file="SqliteSchemaReaderTest.cs" company="Poco Generator for Lite ORMs">
...
namespace PocoGen.Tests
{
    ...
    /// <summary>
    /// This class represents SqliteSchemaReaderTest class.
    /// </summary>
    public class SqliteSchemaReaderTest
    {
        private readonly string _connectionString;
        private const string Namespace = "Sqlite.Models";

        public SqliteSchemaReaderTest()
        {
            _connectionString = ConfigurationManager.ConnectionStrings["SqliteConnectionString"].ConnectionString;
        }

        [Fact]
        public void TableCounTest()
        {
            using (var schemaReader = SchemaReaderProvider.GetReader(DbServerType.Sqlite))
            {
